## Take first n lines from the 16GB train data and write them into a single file caled 'train_small'

# The number of lines to take:
n = 1000000 # There are about 160 million lines in the train file.
...
new_file_path = os.path.join(data_dir, "train_small")
